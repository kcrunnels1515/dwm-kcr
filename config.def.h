...
static Key keys[] = {
	...
	{ Mod1Mask,                     XK_q,	    XK_m,	spawn,	       SHCMD("/usr/local/share/scripts/dmenumount.sh")},
	{ Mod1Mask,                     XK_q,	    XK_u,	spawn,	       SHCMD("/usr/local/share/scripts/dmenuumount.sh")},
	{ Mod1Mask,                     XK_q,	    XK_r,	spawn,	       SHCMD("/usr/local/share/scripts/dmenu-scrot.sh")},
	{ Mod1Mask,                     XK_q,	    XK_o,	spawn,	       SHCMD("/usr/local/share/scripts/dmenu-emoji.sh")},
